        ...
        <div class="p-10 ml-6 mr-6">
          ...
          <div class="flex grid grid-flow-row auto-rows-max items-center mt-7 mx-7 gap-4 justify-center">
            <div class="grid grid-flow-col auto-cols-max gap-4">
              ...
              <button class="bg-purple-500 hover:bg-purple-700 text-white py-2 px-8 mx-2 rounded font-bold">View Quiz</button>
              <router-link to="/MyQuizzes" tag="button">
                <button class="bg-lime-500 hover:bg-lime-700 text-black hover:text-white py-2 px-8 mx-2 rounded font-bold">Select Quiz</button>
              </router-link>
            </div>
            <div class="grid grid-flow-col auto-cols-max gap-4">
