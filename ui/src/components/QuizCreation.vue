        ...
        >
          ...
          <div class="w-full my-5">
            <div class="grid grid-flow-col">
              ...
              <h3 v-if="store.question.timer===undefined"
              class="ml-2 text-sm font-medium text-white"  > Please enter a time timit for this question.</h3>
            </div>
          </div>
          <div
            class="w-full my-5"
      ...
      <div class="flex grid grid-cols-1 gap-8 justify-items-center m-5 w-11/12">
        <div>
          ...
          <!-- <router-link :to="{ path: '/QuizCreationSummary',}"> -->
            ...
            <button v-if="store.questions.length < 7" 
