    ...
    <div class="p-10 ml-6 mr-6">
      ...
      <div class="grid grid-cols-6 gap-4">
        ...
        <div class="col-start-2 col-span-4 mb-6">
          <img class="card rounded-lg object-fill w-full h-64 flex" src="https://images.unsplash.com/photo-1543158015-04650a9d832a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2833&q=80"/>
        </div>
      </div>
