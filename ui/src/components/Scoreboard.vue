    ...
    <template>
      <div class="bg-quiz w-screen h-screen bg-no-repeat bg-cover text-white">
        <div class="p-10 ml-6 mr-6">
          ...
          <!--Scoreboard-->
          <div class="mx-auto p-4 mt-16 max-w-xl rounded overflow-hidden font-bold bg-purple-100 text-purple-800">
            ...
            <div class="flex items-center py-4">
              <div class="w-4/6 flex">
                <img class="w-6 sm:w-10 mr-2 self-center" src="https://cdn.shopify.com/s/files/1/1061/1924/products/Emoji_Icon_-_Cowboy_emoji_grande.png?v=1571606089">
