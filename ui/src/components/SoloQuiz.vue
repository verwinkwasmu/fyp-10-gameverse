      ...
      <div class="p-10 ml-6 mr-6">
            ...
            <div class="col-start-2 col-span-4">
              <div class="grid grid-rows-2 grid-cols-2 gap-0 place-content-stretch">
                ...
                <button class="button h-24 m-2 box-border rounded-lg hover:bg-blue-900"
                  ...
                  v-html="option" @click="showAnswer(option)"></button>
        ...
        <div v-else-if="qnAnswered && timer != 0">
          <div class="grid grid-flow-row grid-col-1 gap-1">
            ...
            <div class="text-lg font-bold text-center">Waiting for other users to respond...</div>
          </div>
        </div>
...
function checkAnswers() {
  ...
  if (store.quiz.questions[qnNumStore.qnNum].options[answer_key] == answer_input.value) {
