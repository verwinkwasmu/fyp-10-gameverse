    ...
    <div class="p-10 ml-6 mr-6 ">
      ...
      <div class="flex grid grid-flow-row auto-rows-max items-center mt-7 mx-7 gap-3 justify-center ">
        ...
        <div class="grid grid-flow-col auto-cols-max gap-4" v-for="(quiz,index) in quizzes" :key="index">
          ...
          <div class="font-bold text-gray-700 rounded-full bg-white flex items-center justify-center w-12 h-12 align-middle	">
            {{index +1}}
          </div>
          ...
          <button class="bg-lime-500 hover:bg-lime-700 text-black hover:text-white py-2 px-8 rounded font-bold" @click="startGame(quiz.id)">
            Start Game
          </button>
