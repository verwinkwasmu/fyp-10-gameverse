    ...
    <div class="p-10 ml-6 mr-6">
      ...
      <div class="mx-auto mt-16 max-w-xl rounded overflow-hidden">
              ...
              <div class="basis-1/3 pb-4">
                <div>
                  <button
                    ...
                    "
                    class="grid justify-items-end bg-cyan-600 px-8 py-3 text-white hover:bg-cyan-700 rounded-xl"
                  ...
                  <button
                    v-else
                    class="grid justify-items-end bg-red-600 px-8 py-3 text-base text-white hover:bg-red-700 rounded-xl"
        ...
        <div class="flex justify-center pt-10">
          <router-link class="btn-return" :to="{path: '/AllQuizQuestionBank'}"
