  ...
  <div class="bg-quiz w-screen h-screen bg-no-repeat bg-cover text-white overflow-auto">
    <div class="p-10 ml-6 mr-6">
      ...
      <div class="grid grid-rows-2 grid-flow-col gap-2">
        ...
        <div class="text-2xl col-span-2">Question from {{ route.params.category }}</div>
      </div>
      <div class="mx-auto mt-16 max-w-xl rounded overflow-hidden">
        ...
        <div v-if="isSuccess">
          <div v-for="(question, index) in data" :key="index">
            ...
            <div class="flex grid grid-flow-row auto-rows-max gap-4">
              <div class="w-full justify-left text-base pt-4 font-medium text-white">
                <div class="grid grid-flow-col auto-cols-max gap-4">
                  <div v-if="question.answer == 'option_1'"
            ...
            <div class="w-full justify-left text-base font-medium text-white">
                <div class="grid grid-flow-col auto-cols-max gap-4">
                  <div v-if="question.answer == 'option_2'"
                      class="grid grid-flow-col auto-cols-max gap-4"
                    >
                    <div
                      class="font-bold text-white rounded-full bg-green-500 flex items-center justify-center w-12 h-12 align-middle"
            ...
            <div class="w-full justify-left text-base font-medium text-white">
                <div class="grid grid-flow-col auto-cols-max gap-4">
                  <div v-if="question.answer == 'option_3'"
                      class="grid grid-flow-col auto-cols-max gap-4"
                    >
                    <div
                      class="font-bold text-white rounded-full bg-green-500 flex items-center justify-center w-12 h-12 align-middle"
            ...
            <div class="w-full justify-left text-base font-medium text-white">
                <div class="grid grid-flow-col auto-cols-max gap-4">
                  <div v-if="question.answer == 'option_4'"
                      class="grid grid-flow-col auto-cols-max gap-4"
                    >
                    <div
                      class="font-bold text-white rounded-full bg-green-500 flex items-center justify-center w-12 h-12 align-middle"
