      ...
      <div class="w-full bg-slate-200 rounded-md shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
        <div class="px-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div>
              ...
              <input v-model="userId" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 w-96" placeholder="Please enter your User ID" required="" @keyup.enter="onSubmit">
            </div>
            ...
            <button v-if="loading == false" @click="onSubmit" class="w-full text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" >Sign in</button>
            <button v-else class="w-full text-white bg-blue-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" disabled>
